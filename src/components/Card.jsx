...
function Card({ title, imgURL, isVisited, description }) { 
  ...
  return(
      <div className="card mb-3 cursor-pointer hover:scale-110 transition delay-150 duration-300 ease-in-out flex-none mx-2 w-60 h-max text-center rounded-lg bg-zinc-900 shadow-2xl">
        <img className="object-cover h-52 rounded w-full" src={imgURL} alt={title} />
        <div className="p-4 h-64 overflow-y-auto break-words hyphens-auto">
